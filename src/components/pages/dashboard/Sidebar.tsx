...
export function DashboardSidebar({ user }: SidebarProps) {
  ...
  return (
    <aside className="fixed left-0 top-0 z-30 flex h-screen w-64 flex-col border-r border-[var(--border-soft)] bg-surface/80 backdrop-blur-xl">
      {/* Brand */}
      ...
      <div className="border-t border-[var(--border-soft)] p-4">
        <div className="mb-3 flex items-center gap-3 rounded-xl bg-zinc-50 p-3 dark:bg-zinc-800/60">
